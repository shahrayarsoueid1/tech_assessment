...
import 'package:topup_app/app/features/beneficiaries/presentation/widgets/phone_number/countries.dart';
...
class PhoneNumber {
  ...
  factory PhoneNumber.parse(String value) {
    ...
    final Iterable<Country> matchedCountries =
        countries.where((Country c) => c.matches(normalizedValue));

    for (final Country item in matchedCountries) {
  ...
  static String normalize(String number) {
    return number.split('').where((String c) => int.tryParse(c) != null).join();
  }
